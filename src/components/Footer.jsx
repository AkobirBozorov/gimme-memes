...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#001F3F] to-[#6EE2F5] text-white py-12">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row sm:items-center">
              ...
              <button
                type="submit"
                className="mt-2 sm:mt-0 sm:ml-2 px-4 py-3 bg-white text-[#001F3F] rounded-md hover:bg-gray-100 transition whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
        ...
        {/* Bottom Footer */}
        <div className="mt-12 border-t border-[#6EE2F5] pt-4 text-center">
          <p className="text-sm text-[#AEDFF7]">
