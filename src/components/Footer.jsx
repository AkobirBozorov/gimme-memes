...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#528265] to-[#C9EFC7] text-white py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Bottom Footer */}
        <div className="mt-12 border-t border-[#C9EFC7] pt-4 text-center">
          <p className="text-sm text-[#E0F5E8]">
